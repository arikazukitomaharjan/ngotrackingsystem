...
@section('content')
    <div class="site_body">
        ...
        <div class="section_hdr clearfix">
            <h1 class="site_page_title"><span class="btn btn_blue">{{ $project->status }}</span> {{ $project->title }}
            </h1>


            <span class="section_hdr_btns_wrp">
                <a href="<?php echo url('/projects/Approved/');?>" class="btn btn_green"><i class="fa fa-check"
                                                                                            aria-hidden="true"></i>Approved</a>
                <a href="<?php echo url('/projects/Proposed/');?>" class="btn btn_blue"><i class="fa fa-minus"
                                                                                           aria-hidden="true"></i>Pending</a>
                <a href="<?php echo url('/projects/Running/');?>" class="btn btn_red"><i class="fa fa-ban"
                                                                                         aria-hidden="true"></i>Running</a>
