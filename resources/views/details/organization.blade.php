...
<span class="section_hdr_btns_wrp"><a
            href="{{ url('/organizations/edit/'.$org->id) }}"> Edit </a> {{ $org->status }}
                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                @foreach($projectList as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                <span class="icon_yellow"> <a href="{{$editLink}}"> <i
                                                class="icon-pencil"></i> </a> </span>
                                <span class="icon_green"> <a href="{{$projectLink}}"> <i
                                                class="icon-eye"></i> </a></span>
                                <span class="icon_red"> <a
                                            onclick="return confirm('Are you sure? You can\'t undo this action.')"
                                            href="{{$deleteLink}}"> <i class="icon-trash-bin"></i> </a></span>
                                        </td>
                                    </tr>
